  ...
  const onSubmit: SubmitHandler<VerifyCodeType> = async (
    ...
    if (typeof response === "boolean") {
      if (path === "password/forgot") {
        showToast(t("auth.verifyCode.success"));
            ...
            <Text style={styles.welcomeText}>
              {t(
                path === "password/forgot"
                  ? "auth.verifyCode.titlePassword"
                  : "auth.verifyCode.titleMail"
              )}
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            {errors.code && (
              <Text style={styles.errorText}>
                {t("common.error")} : {errors.code.message}
              </Text>
            )}
            {errors.email && (
              <Text style={styles.errorText}>
            ...
            <Button
              ...
              title={t("auth.verifyCode.resentCode")}
              loading={loadingCode}
              onPress={resetCode}
            />
            <Button
              title={t("auth.verifyCode.confirm")}
